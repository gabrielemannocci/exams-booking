...
public class ExamsbookingApplicationParams {
	...
	public static final String INVALID_STUDENT_ERROR_MSG = "Something wrong happened storing Student data: missing field value";
	...
	public static final String NO_EXAMS_FOUND_ERROR_MSG = "No exams found!";
	
	public static final String EXAMSBOOKING_RESULT_VIEW = "results";
	public static final String EXAMSBOOKING_ERROR_VIEW = "error";
}
